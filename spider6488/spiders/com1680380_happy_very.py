...
from spider6488.common.common import sum_value_11x5, dragon_tiger_chongq, trend_by_issue_total, big_small_chongq, \
    trend_big_small_chongq, single_double_chongq, trend_single_double_chongq
from spider6488.common.constants import lottery_code_map


class Com1680380HappyVerySpider(scrapy.Spider):
    name = 'com1680380_happy_very'
    ...
    start_urls = [
        ...
        # 天津快乐十分
        # 开奖号码
        'https://api.api861861.com/klsf/getHistoryLotteryInfo.do?date=%s&lotCode=10034' % _today,
        # 基本走势
    ...
    def lot_num_parse(self, response):
        ...
        for i in res['result']['data']:
            ...
            if '10038' == response.url.split('=')[-1]:      # 广西快乐十分
                item = {
