...
class KillNoPlanSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        'https://api.api861861.com/KillNum/getSscKillNumList.do?lotCode=10004&rows=30&date=%s' % _yesterday,
        # # 极速时时彩
        ...
        'https://api.api861861.com/KillNum/getEfKillNumList.do?lotCode=10018&rows=30&date=%s' % _yesterday,
        # 辽宁11选5
